...
execute "hi Conditional  gui=none guifg=" . s:Butter[2]
...
execute "hi PreProc      guifg=" . s:Chocolate[1]
execute "hi Repeat       gui=none guifg=" . s:Butter[2]
...
execute "hi Todo         gui=none guisp=NONE guibg=" . s:Orange[2]
            \. " guifg=" . s:Aluminium[0]
execute "hi Type         gui=none guifg=" . s:Orange[2]
...
execute "hi StatusLine   gui=none guibg=" . s:Plum[1] . " guifg=" . s:Aluminium[0]
